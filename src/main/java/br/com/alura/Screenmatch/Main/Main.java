...
public class Main{
    ...
    public void exibeMenu() throws JsonProcessingException {
        ...
        List<DadosEpisodio> dadosEpisodios = temporadas.stream()
                ...
                .collect(Collectors.toList()); //ou .toList(), mas retorna uma lista imutável
...
//                .forEach(System.out::println);
        ...
        Optional<Episodio> pesquisa = episodios.stream()
                .filter(e -> e.getTitulo().toUpperCase().contains(trechoTitulo.toUpperCase()))
                .findFirst();
        if (pesquisa.isPresent()){
            System.out.println("Episódio encontrado: ");
            System.out.println("Temporada: "+ pesquisa.get().getTemporada());
            System.out.println("Episódio: " + pesquisa.get().getTitulo());
        }else{
